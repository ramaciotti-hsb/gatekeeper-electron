...
export default class WorkspaceView extends Component {
    ...
    renderSubGateTemplates (gateTemplate) {
        ...
        return childGroups.map((childGateTemplateGroup) => {
            ...
            return (
                <div className={'sidebar-gate-template-group' + (gatingError ? ' gating-error' : '')} key={childGateTemplateGroup.id} onClick={this.props.showGatingModal.bind(null, this.props.workspace.selectedSample.id, childGateTemplateGroup.selectedXParameterIndex, childGateTemplateGroup.selectedYParameterIndex )}>
                    <div className='title'>
